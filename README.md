...
## Projet1 -> Web Scraper et recommandation de produit
...
## Projet 2 -> Plateforme d'apprentissage en ligne
...
## Project5 -> Plateforme d'apprentissage en ligne pour l'amélioration des compétences linguistiques et la préparation aux tests
...
## Project6 -> Projet d'analyse et de sélection de modèles pour la prédiction de l'antigène spécifique de la prostate (lpsa)
...
## Project7 -> Comparaison des Algorithmes pour la Résolution du Problème des N-Reines en Intelligence Artificielle
...
## Projet 9 -> Top 5% dans la Compétition Kaggle - Prédiction des Prix des Maisons
...
## Projet 10 -> Outil de Prise de Décision en Situation d'Incertitude : Une Application Web en Python Flask
...
## Projet 11 -> Participation à un Hackathon : Système de Gestion des Ressources Humaines pour les Hôpitaux avec Intégration de l'Apprentissage Automatique
...
## Projet 12 -> Lauréats du 3ème Prix - Hackathon Airbnb et Jeux Olympiques 2024
